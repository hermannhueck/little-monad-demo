...
object Example12Function1MonoidInstances extends App {
  ...
  val fComposedWithCompose2 = lii.combineAll(function1ComposeMonoid)
  ...
  val fComposedWithApply = lis.combineAll(function1ApplyMonoid)
